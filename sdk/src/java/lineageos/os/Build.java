...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.spark.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.spark.display.version");
    ...
    public static class LINEAGE_VERSION {
        ...
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.spark.build.version.plat.sdk", 0);
    }
